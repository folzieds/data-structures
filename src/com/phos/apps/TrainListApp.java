...
public class TrainListApp {

    List<TrainCar> train = new ArrayList<>();

    public static void main(String[] args) {
        long start = System.currentTimeMillis();
        TrainListApp app = new TrainListApp();
    ...
    private void buildInitialTrain() {
        ...
        int position = train.lastIndexOf(car3);
